    ...
    return(
        <Header>
            ...
            <div className="contenedor-info">
                ...
                <button onClick={() => window.open('https://api.whatsapp.com/send?phone=2235915998&text=Hola,%20te%20escribo%20para%20las%20entradas%20de%20la%20picante', '_blank')}  className="boton">{props.button}</button>
        </Header>
    )
}
